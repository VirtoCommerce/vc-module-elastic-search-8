...
namespace VirtoCommerce.ElasticSearch8.Tests
{
    ...
    {
        public const string TypeName = "VirtoCommerce.ElasticSearch8.Tests.PriorityTestCaseOrderer";
        public const string AssemblyName = "VirtoCommerce.ElasticSearch8.Tests";
